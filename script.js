  ...
  if (formContacto) {
    formContacto.addEventListener("submit", function (e) {
      ...
      if (
        ...
        e.preventDefault();
        alert(
          "Por favor, completa todos los campos antes de enviar. | Please complete all fields before sending."
        );
      }
    });
  }
...
const traducciones = {
  es: {
    ...
    "li.inv":
      "Conocimiento en desarrollo basado en investigación y método científico",
    ...
    "proyectosspan.2":
      "Desarrollo de un e-commerce inspirado en una tienda de la vida real; al ser mi primer proyecto NO es semántico, no es accesible, no es responsive y, aunque en su momento lo 'clavé' como un proyecto full stack, realmente fue todo front y lo demás pura labia. Es mi bebé, con el que comencé todo, le tengo un especial cariño y me doy cuenta lo mucho que he mejorado en esto. Todo es un coctél de cosas, no sabes en donde enfocar tu vista por tantos eventos que acontecen en el momento pero, no me juzguen, fue mi primer contacto con un desarrollo front-end.",
    "proyectos.3": "Proyecto de Servicio Social 'My Health App'",
    "proyectosspan.3":
      "Proyecto desarrollado en conjuto con el departamento de investigación de mi universidad | Desarrollo de un dispositivo de monitoreo del ritmo cardíaco utilizando como corazón la placa Esp32 y el sensor de monitoreo cardíaco. El sistema cuenta con sus interfaces gráficas en escritorio y una vista en mobile gracias a su sincronización con una app de monitoreo.",
    "proyectos.4": "Proyecto escolar 'Sembrando agua'",
    "proyectosspan.4":
      "Desarrollo de un invernadero con riego automatizado basado en las condiciones climatológicas y empleando la placa Esp32 como el corazón del proyecto. Mi rol principal: Desarrollo de la interfaces visuales para los datos provenientes de los sensores, así como el manejo de datos en bruto en la Base de datos Mysqul.",
    "proyectosspan.5":
      "Un proyecto web hecho con cariño, para conmemorar el Día del Padre y celebrar todo lo que mi papá significa en mi vida. No acepto malos comentarios o algo por el estilo por temas de subjetividad al deporte y equipo que a él le apasionan. ",
    "proyectosspan.6":
      "Este repositorio fue creado con la finalidad de culminar mis estudios del curso Angular impartido por código facilito. Opté por inspirarme en mi novia para dedicarle esta creación donde no solo empleamos front-end, sino back-end, bases de datos, etc, ¡pruébalo!.",
    "informacion.ingreso":
      "Puedes ingresar al proyecto usando mis credenciales de usuario: Usuario - Kevin-fit-18 | Contraseña: Guffy",
    "proyectosspan.7":
      "Micro Proyecto realizado con la finalidad de conmemorar la entrega de flores amarillas aquí en mi natal México. Puede ser pequeño pero al no poder estar cerca de mi pareja, este fue mi pequeño presente y no, no fue cultivado a base de abono y lluvia, sino de código bien estructurado y mucho, si mucho CSS, ese fue el abono 🤭🤣🌻.",
    "proyectos.8": "Cv-Propio",
    "proyectosspan.8":
      "Este código fue realizado para la creación de mi currículum vitae (cv), con la finalidad de aumentar mi impacto y nivel de conversión ante los empleadores, demostrar mis conocimientos y, sobre todo, las enormes ganas que tengo de formar parte del mundo tech.",
    "proyectosspan.9":
      "Este código fue realizado para la creación del currículum vitae (cv) de la señorita Isis Alejandra Avendaño Eligio con el propósito de ayudarla en su búsqueda de trabajo y mejorar el impacto que tiene ante los reclutadores. Es un sitio responsive, adaptado para toda pantalla y con un estilo visual encantador, puedes entrar a checarlo si gustas, puedes notar algunos detalles puntuales porque la señorita no me pasó su cv pdf (ya entenderás si entras porque el pdf era tan importante🤣).",
    "proyectos.activos": "⚠️ Proyectos en Proceso ⚠️",
    "proyectosspan.10":
      "Este sitio web fue realizado para la creación del currículum vitae (cv) de la señorita Naidelin Anaí Torres Meza (Ingeniera en Logística) con el propósito de ayudarla en su búsqueda detrabajo y mejorar el impacto que tiene ante los reclutadores. Es un sitio responsive, adaptado para toda pantalla y con un estilo visual encantador.",
    "activosspan":
  ...
  en: {
    ...
    "about.intro":
      "Passionate about the technological world, modern solutions, and turning my ideas into code.",
    "about.text1":
      "Hello, I am Kevin Alexander Meza Morales, graduated from the Engineering in Information and Communication Technologies (ICTs) of the Instituto Tecnológico Superior de Naranjos. ",
    "about.text2":
      "Reborn as a Phoenix bird I am currently 22 years old, although they say age is timeless, I am passionate about web development, research and healthy living. Be careful, do not be confused, I am not a laboratory rat, I also like to exercise, draw, play piano and cook, but above all learn new things.",
    ...
    "p.learning":
      "I have full initiative to learn new technologies and stay up-to-date with the market and trends. Check it out! 🧠⚡",
    "proyectos.title": "🚀 Recent Projects",
    "proyectos.1": "PYMETECH store",
    "proyectosspan.1":
      "ECommerce development for technology company in Tampico, with responsive design, SEO and WordPress customization.",
    "proyectos.2": "The beginning of everything 'La nuestra 🛒'",
    "proyectosspan.2":
      "Development of an e-commerce site inspired by a real-life store; being my first project, it is NOT semantic, it is not accessible, it is not responsive, and although at the time I 'nailed' it as a full-stack project, it was really all front-end and the rest pure talk. It's my baby, the one I started it all with; I have a special affection for it and I realize how much I've improved in this. Everything is a cocktail of things; you don't know where to focus your attention due to so many events happening at the moment, but, don't judge me, it was my first contact with front-end development.",
    "proyectos.3": "Proyecto de Servicio Social 'My Health App'",
    "proyectosspan.3":
      "Project developed in conjunction with my university's research department | Development of a heart rate monitoring device using the Esp32 board and the heart rate monitoring sensor as the heart. The system has graphical interfaces on the desktop and a mobile view thanks to its synchronization with a monitoring app.",
    "proyectos.4": "School Project 'Sowing Water'",
    "proyectosspan.4":
      "Development of a greenhouse with automated irrigation based on weather conditions, using the ESP32 board as the core of the project. My main role: Development of visual interfaces for sensor data, as well as management of raw data in the MySQL database.",
    "proyectosspan.5":
      "A web project created with love to commemorate Father's Day and celebrate everything my dad means to me. I don't accept negative comments or anything of the sort due to subjective opinions about the sport and team he's passionate about.",
    "proyectosspan.6":
      "This repository was created to complete my Angular course taught by Código Facilito. I chose to be inspired by my girlfriend to dedicate this creation to her. We use not only the front-end but also the back-end, databases, and more. Try it!",
    "informacion.ingreso":
      "You can log in to the project using my login credentials: Username: Kevin-fit-18 | Password: Guffy",
    "proyectosspan.7":
      "A micro-project commemorating the delivery of yellow flowers here in my native Mexico. It may be small, but since I couldn't be near my partner, this was my little present. No, it wasn't cultivated with fertilizer and rain, but with well-structured code and lots, lots of CSS. That was the fertilizer. 🤭🤣🌻",
    "proyectos.8": "My Resume",
    "proyectosspan.8":
      "This code was created to create my resume (CV), with the goal of increasing my impact and conversion rate with employers, demonstrating my knowledge, and, above all, my enormous desire to be part of the tech world.",
    "proyectosspan.9":
      "This code was created to create Miss Isis Alejandra Avendaño Eligio's resume (CV) to help her in her job search and improve her impact on recruiters. It's a responsive site, adapted for all screens, and with a charming visual style. You can check it out if you like. You may notice some specific details because the lady didn't send me her CV in PDF format (you'll understand why the PDF was so important if you log in).",
    "proyectosspan.10":
      "This website was created to create the resume (CV) of Miss Naidelin Anaí Torres Meza (Logistics Engineer) to assist her in her job search and improve her impact on recruiters. It is a responsive site, adapted to fit all screens, and has a charming visual style.",
    "proyectos.activos": "⚠️ Projects in Progress ⚠️",
    "activosspan":
      "The following are projects currently in progress, built in Angular and with two different purposes. Potential names: Fuel-by-Peanut and Fit-couch-panel.",
